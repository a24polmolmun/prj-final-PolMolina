...
2. [Accés al sistema](#2-accés-al-sistema)
3. [Funcions comunes](#3-funcions-comunes)
...
### 5.6. Gestió de la classe com a tutor
...
### 7.4. No apareixen alumnes en passar llista
...
### 7.5. No puc desar una sessió d'horari
...
### 7.6. No puc enviar un justificant
...
### 7.7. No puc eliminar un registre
